...
import pygraphviz
from src.utils.sem_utils.toy_sems import StationaryDependentSEM, StationaryIndependentSEM, NonStationaryDependentSEM, HealthcareSEM, EpidemiologySEM
...
def setup_stat_scm_ceo_epidem(random_state, n_anchor, T: int = 0):
    ...
    base_dag = nx_agraph.from_agraph(pygraphviz.AGraph(base_dag_view.source))
